    ...
    <li style="border-bottom:1px solid rgb(196,196,196);">
       ...
       <br> 
        ...
        <?php $donnees = $req->fetch(); } $req->closeCursor();     ?> </ul>
                <br><br><br><br>
        <?php if($page>1)  {  ?>
        <a class="chevron"  href="/INTR_SEC/admin/blog/?page=<?php echo ($page-1); ?>"><img src="../images/last.png" style="width:20px;height:20px;" alt=""></a> 
        <a <?php if($page<($nombrePages)) { ?>class="chevron" href="/INTR_SEC/admin/blog/?page=<?php echo ($page+1); ?>" 
            <?php }else{ ?>class="chevrond"<?php } ?> ><img style="width:20px;height:20px;" src="../images/next.png" alt=""></a>
        <?php }  ?>

        <?php if($page==1)  {  ?>
        <a class="chevron"  href="/INTR_SEC/admin/blog/"><img src="../images/last.png" style="width:20px;height:20px;" alt=""></a> 
        <a <?php if($page<($nombrePages)) { ?>class="chevron" href="/INTR_SEC/admin/blog/?page=<?php echo ($page+1); ?>"
            <?php }else{ ?>class="chevrond"<?php } ?> ><img style="width:20px;height:20px;" src="../images/next.png" alt=""></a>
        <?php }  ?>
        ...
        <a <?php if($page<($nombrePages)) { ?>class="chevron" href="/INTR_SEC/admin/blog/?page=<?php echo ($page+1); ?>" <?php }else{ ?>class="chevrond" <?php } ?>>
